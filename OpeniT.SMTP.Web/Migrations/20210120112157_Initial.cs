        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    _Roles = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SmtpMails", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "SmtpMailAddresses",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ...
                    DisplayName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SmtpMailId = table.Column<int>(type: "int", nullable: true),
                    SmtpMailId1 = table.Column<int>(type: "int", nullable: true),
                    DateCreated = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedById = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DateUpdated = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LastUpdatedById = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_SmtpMails_SmtpMailAddresses_FromId",
                table: "SmtpMails",
                column: "FromId",
                principalTable: "SmtpMailAddresses",
                principalColumn: "Id",
                onDelete: ReferentialAction.Restrict);
        }
