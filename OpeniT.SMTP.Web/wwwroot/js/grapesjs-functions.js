(function () {
    window.GrapesjsFunctions = {
        init: function (editorElement) {
            ...
            var parserConfig = editor.Parser.getConfig();
            parserConfig.keepEmptyTextNodes = true;
            ...
            editor.on('load', function () {
                ...
                var buttons = editorElement.querySelectorAll("button");
            ...
            editor.on('modal:open', function () {
                var modalContainer = editorElement.querySelectorAll(".gjs-mdl-container")[0];
                if (modalContainer) {
                    document.body.appendChild(modalContainer);

                    var buttons = modalContainer.querySelectorAll("button");
                    for (var i = 0; i < buttons.length; i++) {
                        var el = buttons[i];
                        el.setAttribute("type", "button");
                    }
